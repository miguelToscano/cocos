...
CREATE INDEX ON marketdata USING BTREE(instrument_id);
CREATE INDEX ON marketdata USING BTREE(date);
...
INSERT INTO "orders" (instrument_id,user_id,size,price,side,status,type,datetime) VALUES
